...
public class Cat : MonoBehaviour, DamageableImp
{
    protected int lv = 0;
    public double hp { get; set; }
    protected float boss_attack = 0;  //보스 데미지 피해량 
    protected bool is_passive_skill = false;
    protected bool is_ative_skill = false;
    ...
    public Cat (BaseCatData _cat_data, GrowingData _growing_data, GameObject _damage_prefab)
    {
        cat_data = _cat_data;
